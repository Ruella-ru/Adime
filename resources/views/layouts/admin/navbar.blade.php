    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link @yield('homeActive')"
                ...
                @if (Auth::user()->isAdmin())
                    <li class="nav-item">
                        <a class="nav-link @yield('jenisActive')"
                            href="{{ route('admin.jenis.index') }}">{{ __('Jenis') }}</a>
                    </li>
                @endif
                ...
                @if (Auth::user()->isAdmin() || Auth::user()->isAuthor())
                    <li class="nav-item">
                        <a class="nav-link @yield('productsActive')"
                            href="{{ route('admin.products.index') }}">{{ __('Product') }}</a>
                    </li>
                @endif
                @if (Auth::user()->isAdmin())
                    <li class="nav-item">
