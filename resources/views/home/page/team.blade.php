                    ...
                    @forelse ($team as $val)
                        <div class="col-md-6 col-lg-4 mb-3">
                            <div class="card h-100 shadow-sm border-0 text-center">
                                <img src="{{ $val->image ? asset('storage/' . $val->image) : 'https://i.pinimg.com/736x/ff/40/a4/ff40a42391910877d835d1c5562fcf50.jpg' }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-3">
                                        <a target="_blank"
                                            ...
                                            class="btn btn-outline-primary btn-sm rounded-pill me-2">Email</a>
                                        <a target="_blank"
                                            href="https://api.whatsapp.com/send/?phone=%2B62{{ $val->phone }}"
                                            class="btn btn-outline-success btn-sm rounded-pill">Phone</a>
                                    </div>
                                </div>
                            </div>
                        </div>
