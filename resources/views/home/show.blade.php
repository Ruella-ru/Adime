        ...
        <div class="row gx-4">
            <div class="col-lg-9">
                <div class="card shadow-sm border-0 rounded-lg">
                    @if ($products->image)
                        {{-- Jika ada gambar produsct, tampilkan gambar tersebut --}}
                        <div class="ratio ratio-21x9">
                            <img class="card-img-top object-fit-cover rounded-top"
                                src="{{ asset('storage/' . $products->image) }}" alt="Gambar Product: {{ $products->title }}">
                        </div>
                    @else
                        ...
                        <div class="ratio ratio-21x9 rounded-top d-flex align-items-center"
                            ...
                            <h1 class="text-white ms-lg-5 ms-3" style="margin-top: 18%"><b>Product </b> <br> <small>Figur
                                    Terbaik</small></h1>
                        </div>
                    @endif
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="text-muted mb-4 d-flex flex-wrap align-items-center small">
                            <span class="me-3">
                                <i class="fas fa-user me-1"></i> Penulis: <strong>{{ $products->user->name }}</strong>
                            </span>
                            <span class="me-3">
                                <i class="fas fa-tag me-1"></i> Kategori: <strong>{{ $products->category->name }}</strong>
                            </span>
                            <span class="me-3">
