...
@section('content')
    <h1 class="mb-4" style="font-size:x-large">Manajemen Product</h1>
    <hr><br>
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <form action="{{ route('admin.products.index') }}" method="GET" class="d-flex me-3">
                    <input type="text" name="search" class="form-control form-control-sm me-2"
                        placeholder="Cari Judul Product..." value="{{ request('search') }}">
                        ...
                        <tbody>
                            @foreach ($products as $val)
                                <tr>
                                    ...
                                    <td>Rp{{ number_format($val->final_price, 0, ',', '.') }}</td>
                                    <td class="text-center">
                                        <a href="{{ route('admin.products.show', $val->slug) }}"
