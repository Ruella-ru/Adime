                        ...
                        <tbody>
                            @foreach ($articles as $val)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.articles.show', $val->slug) }}" class="text-decoration-none">
                                            {{ $val->title }}
                                        </a>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="{{ route('admin.articles.edit', $val->slug) }}" class="btn btn-sm btn-success mx-1"
                                            title="Edit">
                                            <i class="fas fa-pencil"></i>
                                        </a>
                                        <form action="{{ route('admin.articles.destroy', $val->slug) }}" method="POST"
                                            class="d-inline">
                                            @csrf
                                            @method('DELETE')
